...
//! library (such as Smithay's Client Toolkit) can provide generic [`Dispatch`] immplementations that you
//! can reuse on your own app by delegating thos objects to that provided implementation. See the
